...
function AdminDashboardForm() {
  ...
  const handleContactNumberChange = (event) => {
    ...
    setErrors({
      ...errors,
      contactNumber: isValid ? "" : "Please enter the right number",
    });
  };
  ...
  const programOptions = [
    {
      value: "Infant Care Program (0-12 Months)",
      label: "Infant Care Program (0-12 Months)",
    },
    {
      value: "Toddler Program (1-3 Years)",
      label: "Toddler Program (1-3 Years)",
    },
    {
      value: "Preschool Program (3-5 Years)",
      label: "Preschool Program (3-5 Years)",
    },
    {
      value: "Pre-Kindergarten Program (4-5 Years)",
      label: "Pre-Kindergarten Program (4-5 Years)",
    },
    {
      value: "Full-Day Kindergarten Program",
      label: "Full-Day Kindergarten Program",
    },
    {
      value: "Before and After-School Care",
      label: "Before and After-School Care",
    },
    { value: "Summer & Holiday Programs", label: "Summer & Holiday Programs" },
    {
      value: "Language Learning Programs: Chinese, English, Spanish, French",
      label: "Language Learning Programs: Chinese, English, Spanish, French",
    },
    {
      value: "Special Needs Support Program",
      label: "Special Needs Support Program",
    },
  ];
  ...
  const facilityOptions = [
    {
      ...
      options: [
        ...
        {
          value: "Science Experiment Stations",
          label: "Science Experiment Stations",
        },
  ...
  const servicesOptions = [
    {
      ...
      options: [
        {
          value: "Real-Time Parent Communication",
          label: "Real-Time Parent Communication",
        },
        ...
        {
          value: "Digital Attendance and Check-Ins",
          label: "Digital Attendance and Check-Ins",
        },
        {
          value: "Automated Billing & Invoicing",
          label: "Automated Billing & Invoicing",
        },
        {
          value: "Parent-Teacher Conferences",
  ...
  const amenitiesOptions = [
    {
      ...
      options: [
        {
          value: "Air-Conditioned Classrooms",
  ...
  const extraCurricularOptions = [
    {
      ...
      options: [
        ...
        {
          value: "Sports & Physical Activities",
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Box
                    component="form"
                    sx={{
                      "& .MuiTextField-root": { m: 1, width: "60%", mt: 1 },
                    }}
                    noValidate
                    autoComplete="off"
                  >
              ...
              >
                <div
                  style={{ backgroundColor: "#d0c8d4", borderRadius: "10px" }}
                >
                  <h3
                    style={{
                      color: "#656565",
              ...
              <div className="formGrid-container">
                ...
                <div className="form-group">
                  <Autocomplete
                    ...
                    onChange={(event, value) =>
                      setFormData({ ...formData, extraCurricular: value })
                    }
                    renderTags={(value, getTagProps) =>
                      value.map((option, index) => (
                        <Chip
